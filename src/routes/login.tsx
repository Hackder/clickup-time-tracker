...
export default function Login() {
  return (
    <main class="container mx-auto h-full flex flex-row justify-center items-center relative">
      <img src="/images/login-blob.svg" class="absolute -z-10 left-[40%] top-[35%] transform translate-x-[-50%] translate-y-[-50%]" />
      <LoginForm />
    </main>
  )
}
  ...
  return (
    <Form class="flex flex-col gap-4 py-8 px-12 rounded-2xl w-[32em] shadow-lg bg-white">
      ...
      <small class="text-center">
        ...
        <A class="text-purple-600 underline" target="blank" href="https://clickup.com/api/developer-portal/authentication#generate-your-personal-api-token">here</A>.
      </small>
    </Form>
  )
}
...
const LoadingSpinner: Component = () => {
  return (
    <svg class="animate-spin" width="1.5em" height="1.5em" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
